	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="collapse_target">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link active" href="play.php">Spela</a>	
				</li>			
				<li class="nav-item">
...
<?php
	...
	?>
	<p>Hej och välkommen till mitt Text Adventure!</p>
	<p>Trych här för att starta</p>
	<a class="btn btn-secondary btn-lg active start" role="button" aria-pressed="true" href="play.php?page=7">Starta</a>
	<?php
	}
